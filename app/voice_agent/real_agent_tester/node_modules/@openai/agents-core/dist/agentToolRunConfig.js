...
exports.setToolCallParentSpanOnDetails = setToolCallParentSpanOnDetails;
exports.getToolCallParentSpanFromDetails = getToolCallParentSpanFromDetails;
...
function setToolCallParentSpanOnDetails(details, parent) {
    if (!parent) {
        return;
    }
...
function getToolCallParentSpanFromDetails(details) {
    if (!details || typeof details !== 'object') {
        return undefined;
    }
    return details[TOOL_CALL_PARENT_SPAN_SYMBOL];
}
...
function getInheritedAgentToolRunConfig(parentRunConfig, toolRunConfigOverride) {
    ...
    if (typeof parentRunConfig.tracingDisabled !== 'undefined' &&
...
function mergeAgentToolRunConfig(inheritedRunConfig, toolRunConfigOverride) {
    ...
    const mergedTracing = (0, config_1.mergeTracingConfig)(inheritedRunConfig.tracing, toolRunConfigOverride.tracing);
