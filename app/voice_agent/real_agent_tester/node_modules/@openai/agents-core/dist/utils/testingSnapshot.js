...
exports.snapshotTestingValue = snapshotTestingValue;
...
function isCloneableBuffer(value) {
 ...
 *
 */
function snapshotTestingValue(value, seen = new WeakMap()) {
    ...
    for (const key of Reflect.ownKeys(value)) {
        ...
        Object.defineProperty(snapshot, key, {
            configurable: true,
            enumerable: true,
            value: snapshotTestingValue(value[key], seen),
            writable: true,
        });
    }
    return snapshot;
}
//# sourceMappingURL=testingSnapshot.js.map