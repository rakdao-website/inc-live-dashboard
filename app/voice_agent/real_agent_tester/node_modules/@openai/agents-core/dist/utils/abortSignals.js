...
exports.createSiblingCancellationError = createSiblingCancellationError;
exports.isSiblingCancellationSignal = isSiblingCancellationSignal;
...
function createSiblingCancellationError() {
    return new SiblingCancellationError('Cancelled because a sibling task failed.');
}
function isSiblingCancellationSignal(signal) {
...
function isAbortError(error) {
    ...
    return Boolean(DomExceptionCtor &&
