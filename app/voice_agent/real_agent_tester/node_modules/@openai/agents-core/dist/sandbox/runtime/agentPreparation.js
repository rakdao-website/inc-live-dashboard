...
function prepareSandboxAgent({ agent, session, capabilities, runConfigModel, processManifest = true, tracingParent, workspaceScope = new workspacePaths_1.SandboxWorkspaceScope(), }) {
    ...
    const prepared = agent.clone({
        ...
        instructions: async (runContext, preparedAgent) => {
            ...
            segments.push((0, prompts_1.renderFilesystemInstructions)(runtimeManifest, workspaceScope));
