export function typedMountProviderConfig(entry) {
    switch (entry.type) {
        case 's3_mount':
            return {
                provider: 's3',
                config: typedMountConfig({ bucket: entry.bucket }, {
                    prefix: entry.prefix,
                    region: entry.region,
        ...
        case 'azure_blob_mount':
            return {
                provider: 'azure_blob',
                config: typedMountConfig({ container: entry.container }, {
                    prefix: entry.prefix,
        ...
        case 's3_files_mount':
            return {
                provider: 's3_files',
                config: typedMountConfig({ fileSystemId: entry.fileSystemId }, {
...
//# sourceMappingURL=typedMountConfig.mjs.map