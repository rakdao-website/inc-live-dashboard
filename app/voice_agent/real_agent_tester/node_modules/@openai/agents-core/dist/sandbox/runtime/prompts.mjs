import { renderManifestDescription } from "../manifest.mjs";
...
`;
export function getDefaultSandboxInstructions() {
    return DEFAULT_SANDBOX_INSTRUCTIONS;
}
export function renderFilesystemInstructions(manifest, workspaceScope) {
...
export function renderInstructionSection(title, body) {
    return `# ${title}\n\n${body}`;
}
export function renderRemoteMountPolicyInstructions(manifest, canEditorAccessPath) {
...
export function prompt(strings, ...values) {
