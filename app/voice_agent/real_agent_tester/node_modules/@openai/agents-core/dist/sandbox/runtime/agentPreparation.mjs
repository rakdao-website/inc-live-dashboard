...
import { SandboxWorkspaceScope } from "../workspacePaths.mjs";
...
export function prepareSandboxAgent({ agent, session, capabilities, runConfigModel, processManifest = true, tracingParent, workspaceScope = new SandboxWorkspaceScope(), }) {
    ...
    const prepared = agent.clone({
        ...
        instructions: async (runContext, preparedAgent) => {
            ...
            segments.push(renderFilesystemInstructions(runtimeManifest, workspaceScope));
