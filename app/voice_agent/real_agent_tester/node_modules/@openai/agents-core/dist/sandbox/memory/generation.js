            ...
            await (0, spans_1.withSandboxSpan)('sandbox.memory.flush', {
                ...
                for (const rolloutId of [...this.pendingRolloutIds].sort()) {
                    try {
                        ...
                        (0, logger_1.logModelAndToolActionWarning)(logger_1.default, 'Sandbox memory phase 1 failed:', error, { rolloutId });
                    }
                }
                if (wroteArtifacts) {
                    try {
                        ...
                        (0, logger_1.logModelAndToolActionWarning)(logger_1.default, 'Sandbox memory phase 2 failed:', error);
                    }
                }
            }, this.tracingParent);
        }
