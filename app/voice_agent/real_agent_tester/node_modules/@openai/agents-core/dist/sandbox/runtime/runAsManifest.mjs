import { copyManifestMountCredentialExposurePolicy, Environment, Manifest, } from "../manifest.mjs";
export function sandboxRunAsName(runAs) {
    if (runAs === undefined) {
        return undefined;
    }
...
export function manifestWithRunAsUser(manifest, runAs) {
...
//# sourceMappingURL=runAsManifest.mjs.map