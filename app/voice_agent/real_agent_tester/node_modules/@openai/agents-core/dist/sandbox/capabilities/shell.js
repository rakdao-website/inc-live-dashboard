        ...
        const tools = [
            (0, tool_1.tool)({
                ...
                execute: async ({ cmd, workdir, shell, login, tty, yield_time_ms, max_output_tokens, }, _context, details) => {
                    ...
                    return await (0, spans_1.withSandboxSpan)('sandbox.exec', {
                        cmd,
