...
function manifestWithRunAsUser(manifest, runAs) {
    ...
    const updatedManifest = new manifest_1.Manifest({
    ...
    (0, manifest_1.copyManifestMountCredentialExposurePolicy)(updatedManifest, manifest);
