import { cloneManifest, Manifest } from "../sandbox/manifest.mjs";
import { snapshotTestingValue } from "../utils/testingSnapshot.mjs";
...
export function scriptedSandboxSession(inputs = []) {
    ...
    const state = { manifest: new Manifest() };
    const session = { state };
...
//# sourceMappingURL=scriptedSandboxSession.mjs.map