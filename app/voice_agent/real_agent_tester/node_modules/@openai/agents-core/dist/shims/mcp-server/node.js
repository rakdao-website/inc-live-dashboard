...
const client_1 = require("@modelcontextprotocol/client");
...
function buildCacheableRequestOptions(clientSessionTimeoutSeconds, cacheMode = 'refresh') {
    return {
        ...buildRequestOptions(clientSessionTimeoutSeconds),
        cacheMode,
    };
}
async function listAllMcpTools(client, requestOptions) {
    const tools = [];
...
async function listMcpTools(client, requestOptions) {
...
function getNegotiatedModernCapabilities(client) {
    const capabilities = client.getServerCapabilities();
    return client.getProtocolEra() === 'modern' && capabilities !== undefined
        ? capabilities
        : undefined;
}
function getListedToolForCall(tools, toolName) {
    const tool = tools.find((tool) => tool.name === toolName);
    if (tool?.execution?.taskSupport === 'required') {
        throw new client_1.ProtocolError(client_1.ProtocolErrorCode.InvalidRequest, `Tool "${toolName}" requires task-based execution. Use client.experimental.tasks.callToolStream() instead.`);
    }
    return tool;
}
function listResourcesPage(client, params, requestOptions) {
...
function listResourceTemplatesPage(client, params, requestOptions) {
    const capabilities = getNegotiatedModernCapabilities(client);
    if (capabilities !== undefined && capabilities.resources === undefined) {
...
class NodeMCPServerStdio extends mcpShared_1.BaseMCPServerStdio {
    ...
    constructor(params) {
        ...
        this.timeout = params.timeout ?? client_1.DEFAULT_REQUEST_TIMEOUT_MSEC;
    ...
    async connect() {
        ...
        this._toolsList = [];
        try {
            const { StdioClientTransport } = await Promise.resolve().then(() => __importStar(require('@modelcontextprotocol/client/stdio'))).catch(failedToImport);
            const { Client } = await Promise.resolve().then(() => __importStar(require('@modelcontextprotocol/client'))).catch(failedToImport);
    ...
    async callToolResult(toolName, args, meta, options) {
        ...
        const response = await callWithMCPRequestSignal(options?.signal, (requestSignal) => session.callTool(params, {
        ...
        const result = attachParsedCallToolResultMetadata(response);
    ...
    async listResources(params) {
        ...
        const requestOptions = buildRequestOptions(this.clientSessionTimeoutSeconds);
        const response = await listResourcesPage(this.session, params, requestOptions);
    ...
    async listResourceTemplates(params) {
        ...
        const requestOptions = buildRequestOptions(this.clientSessionTimeoutSeconds);
        const response = await listResourceTemplatesPage(this.session, params, requestOptions);
    ...
    async readResource(uri) {
        ...
        const requestOptions = buildCacheableRequestOptions(this.clientSessionTimeoutSeconds);
...
class NodeMCPServerSSE extends mcpShared_1.BaseMCPServerSSE {
    ...
    async connect() {
        ...
        this._toolsList = [];
        try {
            const { SSEClientTransport } = await Promise.resolve().then(() => __importStar(require('@modelcontextprotocol/client'))).catch(failedToImport);
            const { Client } = await Promise.resolve().then(() => __importStar(require('@modelcontextprotocol/client'))).catch(failedToImport);
    ...
    async listTools() {
        ...
        const session = this.session;
        const cacheGeneration = this._toolsCacheGeneration;
        const response = await runMcpTransportOperation(this.params.url, 'SSE list tools', () => listMcpTools(session, requestOptions));
        this.debugLog(() => `Listed tools: ${JSON.stringify(response)}`);
        assertMcpToolListingIsCurrent({
            listedClient: session,
            currentClient: this.session,
    ...
    async callToolResult(toolName, args, meta, options) {
        ...
        const response = await runMcpTransportOperation(this.params.url, 'SSE tool call', () => callWithMCPRequestSignal(options?.signal, (requestSignal) => session.callTool(params, {
            ...buildRequestOptions(this.clientSessionTimeoutSeconds, {
                timeout: this.timeout,
                signal: requestSignal,
            }),
    ...
    async listResources(params) {
        ...
        const requestOptions = buildRequestOptions(this.clientSessionTimeoutSeconds);
        const response = await runMcpTransportOperation(this.params.url, 'SSE list resources', () => listResourcesPage(this.session, params, requestOptions));
        this.debugLog(() => `Listed resources: ${JSON.stringify(response)}`);
        return response;
    }
    async listResourceTemplates(params) {
        ...
        const requestOptions = buildRequestOptions(this.clientSessionTimeoutSeconds);
        const response = await runMcpTransportOperation(this.params.url, 'SSE list resource templates', () => listResourceTemplatesPage(this.session, params, requestOptions));
        this.debugLog(() => `Listed resource templates: ${JSON.stringify(response)}`);
        return response;
    }
    async readResource(uri) {
...
class NodeMCPServerStreamableHttp extends mcpShared_1.BaseMCPServerStreamableHttp {
    ...
    async loadStreamableHttpRuntime() {
        const clientModule = await Promise.resolve().then(() => __importStar(require('@modelcontextprotocol/client'))).catch(failedToImport);
    ...
    async callToolWithClient(client, toolName, args, meta, options) {
        ...
        const response = await callWithMCPRequestSignal(options?.signal, (requestSignal) => client.callTool(params, {
            ...buildRequestOptions(this.clientSessionTimeoutSeconds, {
                timeout: this.timeout,
                signal: requestSignal,
            }),
        ...
        return attachParsedCallToolResultMetadata(response);
    }
    ...
    async closeStreamableHttpTransport(transport, warningMessage) {
        await transport.close().catch((error) => {
            logMcpTransportWarning(this.logger, this.params.url, 'streamable HTTP cleanup', warningMessage, error);
        });
    }
        ...
        const reconnectPromise = (async () => {
            ...
            try {
                if (sessionId === undefined) {
                    ...
                    await this.closeStreamableHttpTransport(previousTransport, 'Failed to close stale MCP transport:');
                }
    ...
    async listTools() {
        ...
        const session = this.session;
        const cacheGeneration = this._toolsCacheGeneration;
        const response = await runMcpTransportOperation(this.params.url, 'streamable HTTP list tools', () => listMcpTools(session, requestOptions));
        this.debugLog(() => `Listed tools: ${JSON.stringify(response)}`);
        assertMcpToolListingIsCurrent({
            listedClient: session,
            currentClient: this.session,
    ...
    async listResources(params) {
        ...
        const requestOptions = buildRequestOptions(this.clientSessionTimeoutSeconds);
        const response = await runMcpTransportOperation(this.params.url, 'streamable HTTP list resources', () => listResourcesPage(this.session, params, requestOptions));
        this.debugLog(() => `Listed resources: ${JSON.stringify(response)}`);
        return response;
    }
    async listResourceTemplates(params) {
        ...
        const requestOptions = buildRequestOptions(this.clientSessionTimeoutSeconds);
        const response = await runMcpTransportOperation(this.params.url, 'streamable HTTP list resource templates', () => listResourceTemplatesPage(this.session, params, requestOptions));
        this.debugLog(() => `Listed resource templates: ${JSON.stringify(response)}`);
        return response;
    }
    async readResource(uri) {
