...
export type ResolveParsedToolParameters<TInputType extends ToolInputParameters> = TInputType extends StandardSchemaWithJSON<any, any> ? StandardSchemaOutput<TInputType> : TInputType extends ZodObjectLike ? ZodInfer<TInputType> : TInputType extends JsonObjectSchema<any> ? unknown : string;
export type ResolvedAgentOutput<TOutput extends AgentOutputType<H>, H = unknown> = TOutput extends TextOutput ? string : TOutput extends StandardSchemaWithJSON<any, any> ? StandardSchemaOutput<TOutput> : TOutput extends ZodObjectLike ? ZodInfer<TOutput> : TOutput extends HandoffsOutput<infer H> ? HandoffsOutput<H> : unknown extends TOutput ? any : TOutput extends Record<string, any> ? unknown : never;
