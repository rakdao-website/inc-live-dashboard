 ...
 */
export declare function adjustModelSettingsForNonGPT5RunnerModel(explicitlyModelSet: boolean, agentModelSettings: ModelSettings, runnerModel: string | Model, modelSettings: ModelSettings, resolvedModelName?: string): ModelSettings;
