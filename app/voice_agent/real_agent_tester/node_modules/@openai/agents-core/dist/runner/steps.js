...
exports.nextStepSchema = zod_1.z.discriminatedUnion('type', [
    ...
    zod_1.z.object({
        ...
        responseAccepted: zod_1.z.literal(true).optional(),
        localFinalizationStarted: zod_1.z.literal(true).optional(),
    }),
    zod_1.z.object({
...
class SingleStepResult {
    ...
    constructor(originalInput, modelResponse, preStepItems, newStepItems, nextStep, finalOutputSource, toolInvocationCommitItems = newStepItems) {
        ...
        this.toolInvocationCommitItems = toolInvocationCommitItems;
    }
    get generatedItems() {
