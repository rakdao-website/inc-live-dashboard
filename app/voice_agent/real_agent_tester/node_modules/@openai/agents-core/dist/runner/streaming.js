...
var abortSignals_1 = require("../utils/abortSignals.js");
Object.defineProperty(exports, "isAbortError", { enumerable: true, get: function () { return abortSignals_1.isAbortError; } });
function getRunItemStreamEventName(item) {
    ...
    if (item instanceof items_1.RunCompactionItem) {
...
function enqueueRunItemStreamEvent(result, item) {
    ...
    if (!itemName) {
        if (logger_1.default.dontLogModelData || logger_1.default.dontLogToolData) {
            logger_1.default.warn('Unknown item type. Item data is redacted.');
        }
        else {
