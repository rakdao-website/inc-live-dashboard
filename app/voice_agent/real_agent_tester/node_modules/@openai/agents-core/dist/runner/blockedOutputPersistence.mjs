...
import { RunHandoffOutputItem, RunToolCallOutputItem, RunToolSearchCallItem, RunToolSearchOutputItem, } from "../items.mjs";
import { getToolCallName, getToolCallNamespace, getToolCallQualifiedName, } from "../toolIdentity.mjs";
...
export function buildRunItemPersistencePlan(options) {
    const { items, alreadyPersistedCount, currentDeferredIndexes, outputBlocked, canUseHistoryTransactions, } = options;
