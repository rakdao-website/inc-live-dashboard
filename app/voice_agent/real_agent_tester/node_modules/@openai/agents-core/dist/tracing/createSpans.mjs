 ...
 */
export function createTaskSpan(options, parent) {
    return getGlobalTraceProvider().createSpan({
        ...options,
        data: {
            type: 'task',
...
export const withTaskSpan = _withSpanFactory(createTaskSpan);
/**
 * Create a new turn span. A turn represents one agent loop iteration.
 * The span will not be started automatically.
 */
export function createTurnSpan(options, parent) {
    return getGlobalTraceProvider().createSpan({
        ...options,
        data: {
            type: 'turn',
...
export const withTurnSpan = _withSpanFactory(createTurnSpan);
/**
