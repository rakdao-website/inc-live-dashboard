...
export type RealtimeInputAudioTranscriptionConfig = {
    ...
    language?: string;
    languages?: string[];
    model?: 'gpt-transcribe' | 'gpt-live-transcribe' | 'gpt-4o-transcribe' | 'gpt-4o-mini-transcribe' | 'gpt-4o-mini-transcribe-2025-12-15' | 'gpt-4o-transcribe-diarize' | 'gpt-realtime-whisper' | 'whisper-1' | (string & {});
    prompt?: string;
};
