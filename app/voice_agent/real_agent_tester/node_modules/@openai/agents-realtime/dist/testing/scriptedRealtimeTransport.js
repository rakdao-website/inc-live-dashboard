...
exports.ScriptedRealtimeTransport = exports.ScriptedRealtimeConnectionSupersededError = exports.RealtimeTransportNotClosedError = exports.ScriptedRealtimeScenarioCancelledError = exports.IncompleteRealtimeScenarioError = exports.RealtimeCallMatcherError = exports.UnexpectedRealtimeCallError = void 0;
const internal_1 = require("@openai/agents-core/utils/internal");
class UnexpectedRealtimeCallError extends Error {
...
exports.UnexpectedRealtimeCallError = UnexpectedRealtimeCallError;
class RealtimeCallMatcherError extends Error {
    /** The zero-based position of the call in `ScriptedRealtimeTransport.calls`. */
    callIndex;
    actualMethod;
    constructor(call) {
...
exports.RealtimeCallMatcherError = RealtimeCallMatcherError;
class IncompleteRealtimeScenarioError extends Error {
    unconsumedCalls;
    pendingExpectations;
    pendingFailures;
...
exports.IncompleteRealtimeScenarioError = IncompleteRealtimeScenarioError;
class ScriptedRealtimeScenarioCancelledError extends Error {
    pendingExpectations;
...
exports.ScriptedRealtimeScenarioCancelledError = ScriptedRealtimeScenarioCancelledError;
class RealtimeTransportNotClosedError extends Error {
    status;
    constructor(status) {
...
exports.RealtimeTransportNotClosedError = RealtimeTransportNotClosedError;
class ScriptedRealtimeConnectionSupersededError extends Error {
    operation = 'connect';
    constructor() {
...
exports.ScriptedRealtimeConnectionSupersededError = ScriptedRealtimeConnectionSupersededError;
/**
...
class ScriptedRealtimeTransport {
    ...
    #record(call) {
        const callSnapshot = (0, internal_1.snapshotTestingValue)(call);
...
exports.ScriptedRealtimeTransport = ScriptedRealtimeTransport;
function snapshotRecordedRealtimeCall(call) {
    return Object.freeze((0, internal_1.snapshotTestingValue)(call));
}
function displayIndex(index) {
    return index + 1;
}
//# sourceMappingURL=scriptedRealtimeTransport.js.map