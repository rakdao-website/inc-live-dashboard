...
exports.ResponsesWebSocketConnection = exports.ResponsesWebSocketInternalError = exports.RESPONSES_WEBSOCKET_ERROR_MESSAGES = void 0;
...
exports.RESPONSES_WEBSOCKET_ERROR_MESSAGES = {
    connection_closed_before_opening: 'Responses websocket connection closed before opening.',
    connection_closed_before_terminal_response_event: 'Responses websocket connection closed before a terminal response event.',
...
class ResponsesWebSocketInternalError extends Error {
    code;
    constructor(code, message = exports.RESPONSES_WEBSOCKET_ERROR_MESSAGES[code]) {
        super(message);
...
function shouldWrapNoEventWebSocketError(error) {
    ...
    return (error.message ===
        exports.RESPONSES_WEBSOCKET_ERROR_MESSAGES.connection_closed_before_opening ||
        error.message ===
            exports.RESPONSES_WEBSOCKET_ERROR_MESSAGES.connection_closed_before_terminal_response_event);
}
function isWebSocketNotOpenError(error) {
    ...
    if (error.message === exports.RESPONSES_WEBSOCKET_ERROR_MESSAGES.socket_not_open) {
        return true;
    }
...
class ResponsesWebSocketConnection {
    ...
    async waitForOpen(signal, timeoutMs, timeoutErrorMessage) {
        ...
        if (this.#closed ||
            ...
            throw new ResponsesWebSocketInternalError('connection_closed_before_opening');
        }
        const openPromise = new Promise((resolve, reject) => {
            ...
            const onClose = () => {
                cleanup();
                reject(this.#error ??
                    new ResponsesWebSocketInternalError('connection_closed_before_opening'));
            };
            const cleanup = () => {
