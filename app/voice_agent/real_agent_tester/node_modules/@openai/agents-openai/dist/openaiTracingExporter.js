                ...
                try {
                    ...
                    if (response.status >= 400 && response.status < 500) {
                        if (logger_1.default.dontLogModelData || logger_1.default.dontLogToolData) {
                            ...
                            logger_1.default.error(`[non-fatal] Tracing client error ${response.status}. Response data is redacted.`);
                        }
                        else {
                    ...
                    (0, internal_1.logModelAndToolActionError)(logger_1.default, '[non-fatal] Tracing: request failed:', error);
                }
                if (signal?.aborted) {
