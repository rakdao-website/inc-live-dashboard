...
def seed_sample_data(db: Session) -> None:
    ...
    db.add_all([
        ...
        Booking(zone_id="MR_1", booking_type="meeting", booking_name="Investor Strategy Meeting", booking_date=today, booking_time_start=time(11), booking_time_end=time(12)),
        Booking(zone_id="POD_1", booking_type="studio", booking_name="Founder Stories Podcast", booking_date=today, booking_time_start=time(10,30), booking_time_end=time(12,30)),
    ])
    db.flush()
    db.add_all([
